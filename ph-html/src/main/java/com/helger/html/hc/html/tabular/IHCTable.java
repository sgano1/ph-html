...
public interface IHCTable <IMPLTYPE extends IHCTable <IMPLTYPE>> extends IHCElement <IMPLTYPE>
{
  ...
  @Nonnull
  @ReturnsMutableCopy
  default Set <ICSSClassProvider> getAllHeaderClasses ()
  {
  ...
  @Nonnull
  @ReturnsMutableCopy
  default Set <ICSSClassProvider> getAllFooterClasses ()
  {
