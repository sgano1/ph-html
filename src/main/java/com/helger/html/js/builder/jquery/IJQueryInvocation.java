...
public interface IJQueryInvocation <IMPLTYPE extends IJQueryInvocation <IMPLTYPE>>
{
  ...
  * Certain versions of this method are deprecated since jQuery 1.7
  ...
  /**
   * @return The invocation of the jQuery function <code>innerHeight()</code> with return type Number
   * @since jQuery 1.2.6
   */
  @Nonnull
  ...
  * Certain versions of this method are deprecated since jQuery 1.8
  ...
  /**
   * @return The invocation of the jQuery function <code>outerHeight()</code> with return type Number
   */
  @Nonnull
  IMPLTYPE outerHeight ();

  /**
   * @return The invocation of the jQuery function <code>outerWidth()</code> with return type Number
   */
  @Nonnull
  IMPLTYPE outerWidth ();
